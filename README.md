...
## Sobre mim  
Estudante de Engenharia de Software focado em backend, com experiência em projetos pessoais que aplicam Spring, JDBC, MySQL e boas práticas de código. Buscando uma vaga de Desenvolvedor Jr para aplicar meus conhecimentos, crescer na área e ser reconhecido pelo meu potencial.

## O que estudo hoje  
- Java 21 (intermediário)  
- JDBC puro
- Spring / Spring Data JPA (iniciante)  
